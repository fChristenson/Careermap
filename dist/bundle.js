...
/***/ function(module, exports, __webpack_require__) {
	...
	var _careermap = __webpack_require__(159);

	var _careermap2 = _interopRequireDefault(_careermap);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var name = 'John Smith';
	var steps = [{ name: 'Contact', title: 'Engineer 1 - Developer', focus: 'focus', experience: 'experience' }, { name: 'Channelled', title: 'Engineer 2 - Developer', focus: 'focus', experience: 'experience' }, { name: 'Assistance', title: 'Engineer 3 - Developer', focus: 'focus', experience: 'experience' }, { name: 'Acqusition', title: 'Senior Engineer Developer', focus: 'focus', experience: 'experience' }, { name: 'Application', title: 'Senior Engineer 2 - Developer', focus: 'focus', experience: 'experience' }, { name: 'Impact', title: 'Lead Engineer - Developer', focus: 'focus', experience: 'experience' }, { name: 'Mastery', title: 'Principal Engineer - Developer', focus: 'focus', experience: 'experience' }];
	var skillCategories = [{
	  category: 'Important skills',
	  groups: [{
	    group: 'Skill',
	    skills: ['Cooking', 'Kung fu', 'Farming']
	  }]
	}];

	_reactDom2.default.render(_react2.default.createElement(_careermap2.default, { name: name, categories: skillCategories, steps: steps }), document.getElementById('app'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _skillTable = __webpack_require__(160);

	var _skillTable2 = _interopRequireDefault(_skillTable);

	var _careermap = __webpack_require__(161);
	...
	var Careermap = function (_React$Component) {
	  _inherits(Careermap, _React$Component);

	  function Careermap() {
	    _classCallCheck(this, Careermap);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(Careermap).apply(this, arguments));
	  }

	  _createClass(Careermap, [{
	    key: 'getSteps',
	    ...
	    key: 'renderSkillTables',
	    value: function renderSkillTables() {

	      return this.props.categories.map(function (category, index) {

	        return _react2.default.createElement(_skillTable2.default, { key: index, category: category, steps: this.props.steps });
	      }.bind(this));
	    }
	  }, {
	    key: 'getFocuses',
	    value: function getFocuses() {
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              ...
	              _react2.default.createElement(
	                'th',
	                { className: 'careermap__name', rowSpan: '4' },
	                this.props.name
	              ),
	              _react2.default.createElement(
	                'th',
	...
	var _class = function (_React$Component) {
	  ...
	  _createClass(_class, [{
	    ...
	    value: function getSkills() {
	      ...
	      return this.props.categories.map(function (category, index) {}.bind(this));
	    }
	  }, {
	    key: 'render',
	    value: function render() {

	      var categoryMarkup = _react2.default.createElement(
	        'tr',
	        null,
	        _react2.default.createElement(
	          'th',
	          { colSpan: this.props.steps.length + 2 },
	          this.props.category.category
	        )
	      );
	      var groups = this.props.category.groups.map(function (group, index) {

	        var steps = this.props.steps.map(function (_, index) {
	        ...
	        var groupTd = _react2.default.createElement(
	          'td',
	          { rowSpan: group.skills.length },
	          group.group
	        );
	        var firstSkillTd = _react2.default.createElement(
	          'td',
	          null,
	          group.skills.shift()
	        );
	        var firstRow = _react2.default.createElement(
	          'tr',
	          null,
	          groupTd,
	          firstSkillTd,
	        ...
	        var array = group.skills.map(function (skill, index) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/postcss-loader/index.js!./careermap.scss", function() {
				var newContent = require("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/postcss-loader/index.js!./careermap.scss");
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".careermap {\n\n}\n\n.careermap__name {\n  color: #fff;\n}\n", ""]);
